...
export default function HeroForm() {
  ...
  return (
    <section
      id="hero-form"
      className="relative pt-28 md:pt-36 pb-16 md:pb-24 bg-gradient-to-b from-white to-brand-gray dark:from-zinc-950 dark:to-zinc-900 overflow-hidden transition-colors duration-300"
    >
      {/* Decorative Blobs */}
      ...
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto mb-10 group shadow-card">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-card border border-gray-100 dark:border-zinc-800 overflow-hidden transition-all duration-500 transform group-hover:-translate-y-1">
            {/* Progress Bar */}
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col">
                        <input
                          ...
                          onKeyDown={handleKeyDown}
                          placeholder={currentQ.placeholder}
                          className="w-full bg-transparent border-b-2 border-gray-200 dark:border-zinc-800 focus:border-brand-blue outline-none text-lg py-3 px-1 transition-colors text-brand-dark dark:text-white"
                        />
                        <div className="mt-8 flex justify-center">
                          <button
                            onClick={handleNext}
