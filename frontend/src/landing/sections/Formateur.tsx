    ...
    <section id="formateur" className="py-20 md:py-28 bg-white dark:bg-black transition-colors duration-300" ref={ref}>
      <div className="section-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
          ...
          >
            <h2 className="text-2xl md:text-4xl font-bold text-brand-dark dark:text-white mb-6">
              Votre Expert en{" "}
              <span className="text-brand-blue">E-Commerce</span>
            </h2>

            <div className="bg-brand-gray dark:bg-zinc-900/50 rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl px-5 py-4 shadow-sm">
